...
@prototype */
	{
public:
	inline TAccessPointInfo(TUint aApId);
	inline TUint AccessPoint() const;
	inline void SetAccessPoint(TUint aAccessPoint);
	inline TBool operator== (const TAccessPointInfo& aRhs) const;
